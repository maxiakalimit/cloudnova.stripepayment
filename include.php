<?php
if (class_exists('CloudnovaModuleStripeClass')) return;

class CloudnovaModuleStripeClass
{
    static $module_id = 'cloudnova.stripepayment';
    static $arScanDir = [
        '/local/php_interface/include/sale_payment/stripe/templates',
        '/bitrix/php_interface/include/sale_payment/stripe/templates',
        '/bitrix/modules/cloudnova.stripepayment/sale_payment/stripe/templates',
    ];
